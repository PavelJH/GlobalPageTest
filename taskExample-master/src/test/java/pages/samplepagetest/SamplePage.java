...
public class SamplePage {
    ...
    WebElement autoTestingChoiceAutomationTesting;

    @FindBy(xpath = "//input[@value='Other']")
    WebElement autoEducationChoiseOther;
    ...
    @FindBy(xpath = "//h1[normalize-space()='Sample Page Test']")
    WebElement samplePageTest;
    ...
    public void fillDataGlobalSQAWithoutName(String emailField, String webField){
        emailInput.clear();
        emailInput.sendKeys(emailField);
        webSite.clear();
        webSite.sendKeys(webField);
    ...
    public void choiceValueDataExpertise(){
        autoTestingChoiceAutomationTesting.click();
    }
    public void choiceValueDataEducation(){
        autoEducationChoiseOther.click();
    }
    ...
    public boolean samplePageTest(){
        samplePageTest.findElement(By.xpath("//h1[normalize-space()='Sample Page Test']"));
        return true;
    }
